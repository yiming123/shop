	            ...
	            <div id="DataTables_Table_1_length" class="dataTables_length">
	                <label>
	                    ...
	                    <select name="num" size="1" aria-controls="DataTables_Table_1">
	                        <option value="10" @if($arr['num'] ==5) selected="selected" @endif>
	                            5
	                        </option>
	                        <option value="25" @if($arr['num'] ==15) selected="selected" @endif>
	                            15
	                        </option>
	                        <option value="50" @if($arr['num'] ==20) selected="selected" @endif>
	                            20
	                        </option>
